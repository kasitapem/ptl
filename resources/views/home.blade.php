...
<head>
    ...
    <!-- Webpage Title -->
    <title>Universitas Metamedia</title>
    
    <!-- Styles -->
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,600;0,700;1,400&display=swap" rel="stylesheet">
    <link href="{{ asset ('asset_landing/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset ('asset_landing/css/fontawesome-all.min.css') }}" rel="stylesheet">
    <link href="{{  asset ('asset_landing/css/swiper.css') }}" rel="stylesheet">
	<link href="{{ asset ('asset_landing/css/styles.css') }}" rel="stylesheet">
	
	<!-- Favicon  -->
    <link rel="icon" href="{{ asset ('asset_landing/images/favicon.png') }}">
</head>
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    {{-- bagian untuk memanggil file navigasi.blade --}}
...
<main class="flex-shrink-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="image-container">
                            <img class="img-fluid" src="{{ asset ('asset_landing/images/details-modal.jpg') }}" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset ('asset_landing/images/details-2.svg') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset ('asset_landing/images/project-1.jpg')}}" alt="alternative">
                                <p><strong>Online banking</strong> - pellentesque tincidunt leo eu laoreedt integer quis vanos compren</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset ('asset_landing/images/project-2.jpg') }}" alt="alternative">
                                <p><strong>Loans company</strong> - odio semper, interdum orci molestie, mattis lectus pellentesq aliqu</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset ('asset_landing/images/project-3.jpg')}}" alt="alternative">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="quotes" src="{{ asset ('asset_landing/images/quotes.svg') }}" alt="alternative">
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset ('asset_landing/images/testimonial-1.jpg') }}" alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset ('asset_landing/images/testimonial-2.jpg') }}" alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset ('asset_landing/images/testimonial-3.jpg') }}" alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset ('asset_landing/images/testimonial-4.jpg') }}" alt="alternative">
                                                <div class="text">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="{{ asset ('asset_landing/images/decoration-lines.svg') }}" alt="alternative"><span>Landing page</span><img class="decoration-lines flipped" src="{{ asset ('asset_landing/images/decoration-lines.svg') }}" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="{{ asset ('asset_landing/images/decoration-lines.svg') }}" alt="alternative"><span>Corporate site</span><img class="decoration-lines flipped" src="images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="{{ asset ('asset_landing/images/decoration-lines.svg') }}" alt="alternative"><span>Online shop</span><img class="decoration-lines flipped" src="images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="{{ asset ('asset_landing/images/up-arrow.png')}} " alt="alternative">
    </button>
    <!-- end of back to top button -->
    	
    <!-- Scripts -->
    <script src="{{ asset ('asset_landing/js/bootstrap.min.js') }}"></script> <!-- Bootstrap framework -->
    <script src="{{ asset ('asset_landing/js/swiper.min.js') }}"></script> <!-- Swiper for image and text sliders -->
    <script src="{{ asset ('asset_landing/js/purecounter.min.js') }}"></script> <!-- Purecounter counter for statistics numbers -->
    <script src="{{ asset ('asset_landing/js/isotope.pkgd.min.js') }}"></script> <!-- Isotope for filter -->
    <script src="{{ asset ('asset_landing/js/scripts.js') }}"></script> <!-- Custom scripts -->
</body>
</html>
